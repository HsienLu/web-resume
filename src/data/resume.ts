export const resumeData = {
    ...
    tagline: "具 2 年網頁開發 + 4 年硬體研發經驗，前端以 React 為主，具備 Node.js / MySQL 後端能力",
    summary: "具 2 年網頁開發 + 4 年硬體研發經驗，前端以 React 為主，並具備 Node.js / MySQL 後端能力。曾參與教育平台 AI 教學助手，負責 對話歷程記錄/查詢 等核心功能；亦具備 舊系統維護與風險控管 經驗，重視可維護性、穩定性與清晰文件。",
    highlights: [
